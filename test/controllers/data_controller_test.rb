...
class DataControllerTest < ActionController::TestCase
  ...
  test "should create datum" do
    assert_difference('Datum.count') do
      post :create, datum: { content: @datum.content, course_id: @datum.course_id, student_id: @datum.student_id, type: @datum.type }
    end
  ...
  test "should update datum" do
    patch :update, id: @datum, datum: { content: @datum.content, course_id: @datum.course_id, student_id: @datum.student_id, type: @datum.type }
    assert_redirected_to datum_path(assigns(:datum))
  end
